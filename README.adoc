...
curl -X POST https://keycloak.jarry.dk:8543/realms/playground/clients-registrations/openid-connect \
   -d '{"client_name":"Dyn-Open-Connect-001","redirect_uris":["https://localhost"],"token_endpoint_auth_method":"client_secret_basic","grant_types":["implicit","refresh_token","authorization_code"],"response_types":[],"subject_type":"public","tls_client_certificate_bound_access_tokens":false}' \
    -H "Content-Type:application/json" \
    -H "Authorization: $access_token"
----
...
----
{
  ...
  "client_id": "045b2cf5-58ab-4ce9-8f0e-08180d107b08",
  "client_secret": "h27rAesHZJ6NeyhDubMjjRulS2yp5YK1",
  "client_name": "Dyn-Open-Connect-001",
  ...
  "client_id_issued_at": 1687955701,
  "client_secret_expires_at": 0,
  "registration_client_uri": "https://keycloak.jarry.dk:8543/realms/playground/clients-registrations/openid-connect/045b2cf5-58ab-4ce9-8f0e-08180d107b08",
  "registration_access_token": "eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJiZTZmOTJhYS01Y2EwLTQzMjEtYTE0NS0wNjJjYjFhZTQxYzIifQ..XlHxtaCGy5p4EpUuD1LP2pnQvgRqdlXxwY93QhiEGls",
...
.FAQ
If you get a `error_description` like `Policy 'Trusted Hosts' rejected request to client-registration service. Details: Host not trusted.` you 
can add the ip via https://keycloak.jarry.dk:8543/admin/master/console/#/playground/clients/client-registration/anonymous
