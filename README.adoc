...
=== auth0.com on ID Token and Access Token

https://auth0.com/blog/id-token-access-token-what-is-the-difference/[ID Token and Access Token: What's the Difference?] is a very nice blog post get get you head around ID Token and Access Token.
